# Contributing to RRSV-boiler

Love RRSV-boiler and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/kawing11a/RRSV-boiler/issues) is
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git clone https://github.com/<your-username>/RRSV-boiler.git
    # Navigate to the newly cloned directory
    cd RRSV-boiler
    # Assign the original repo to a remote called "upstream"
    git remote add upstream https://github.com/kawing11a/RRSV-boiler.git
    ```
...
owners to license your work under the terms of the [MIT License](https://github.com/kawing11a/RRSV-boiler/blob/master/LICENSE.md).
